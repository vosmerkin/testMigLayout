...
public final class CurlClient {
    ...
    private CurlClient(String endpoint, HttpMethod method, String data, Map<String, String> headers) {
    ...
    public static class Builder {
        ...
        public CurlClient create() {
            ...
            return new CurlClient(endpoint, method, data, headers);
        }
